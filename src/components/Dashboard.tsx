    ...
    <div className="min-h-screen bg-brutalist-charcoal halftone-bg">
      ...
      >
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="font-display text-3xl md:text-4xl text-brutalist-yellow">
                BBM TRACKER
              </h1>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <label className="font-body text-brutalist-cream text-base mb-2 flex items-center gap-2">
            <MapPin className="w-5 h-5" strokeWidth={3} />
            Wilayah
          </label>
          <Select value={selectedRegion} onValueChange={(v) => setSelectedRegion(v as Region)}>
            <SelectTrigger className="brutalist-border bg-brutalist-charcoal text-brutalist-cream font-body text-lg p-4 h-auto max-w-md">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="brutalist-border bg-brutalist-charcoal text-brutalist-cream">
              <SelectItem value="Kalimantan Timur" className="font-body text-lg">Kalimantan Timur</SelectItem>
              <SelectItem value="DKI Jakarta" className="font-body text-lg">DKI Jakarta</SelectItem>
              <SelectItem value="Jawa Barat" className="font-body text-lg">Jawa Barat</SelectItem>
              <SelectItem value="Jawa Tengah" className="font-body text-lg">Jawa Tengah</SelectItem>
              <SelectItem value="Jawa Timur" className="font-body text-lg">Jawa Timur</SelectItem>
              <SelectItem value="Sumatera Utara" className="font-body text-lg">Sumatera Utara</SelectItem>
              <SelectItem value="Sumatera Selatan" className="font-body text-lg">Sumatera Selatan</SelectItem>
              <SelectItem value="Sulawesi Selatan" className="font-body text-lg">Sulawesi Selatan</SelectItem>
              <SelectItem value="Bali" className="font-body text-lg">Bali</SelectItem>
              <SelectItem value="Papua" className="font-body text-lg">Papua</SelectItem>
            </SelectContent>
          </Select>
        </motion.div>
        ...
        >
          <button
            ...
            className={`brutalist-border px-6 py-3 font-body font-bold transition-all duration-75 hover:translate-x-1 hover:translate-y-1 flex items-center gap-2 whitespace-nowrap ${viewMode === "prices"
          ...
          >
            <FuelIcon className="w-5 h-5" strokeWidth={3} />
            HARGA BBM
          </button>
          <button
            onClick={() => setViewMode("history")}
            className={`brutalist-border px-6 py-3 font-body font-bold transition-all duration-75 hover:translate-x-1 hover:translate-y-1 flex items-center gap-2 whitespace-nowrap ${viewMode === "history"
          ...
          <button
            ...
            className={`brutalist-border px-6 py-3 font-body font-bold transition-all duration-75 hover:translate-x-1 hover:translate-y-1 flex items-center gap-2 whitespace-nowrap ${viewMode === "stats"
          ...
          <button
            ...
            className={`brutalist-border px-6 py-3 font-body font-bold transition-all duration-75 hover:translate-x-1 hover:translate-y-1 flex items-center gap-2 whitespace-nowrap ${viewMode === "vehicles"
          ...
          <button
            ...
            className={`brutalist-border px-6 py-3 font-body font-bold transition-all duration-75 hover:translate-x-1 hover:translate-y-1 flex items-center gap-2 whitespace-nowrap ${viewMode === "backup"
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 brutalist-border brutalist-shadow-yellow bg-brutalist-yellow p-5 z-30"
      >
        <Plus className="w-8 h-8 text-brutalist-charcoal" strokeWidth={3} />
      </motion.button>
